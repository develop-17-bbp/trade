    ...
    for tid, pos_data in rh.get("positions", {}).items():
        if isinstance(pos_data, dict):
            positions_list.append({
                ...
                "unrealized_pnl": pos_data.get("current_pnl_usd_net", pos_data.get("current_pnl_usd", 0)),
                "unrealized_pnl_pct": pos_data.get("current_pnl_pct_net", pos_data.get("current_pnl_pct", 0)),
                "unrealized_pnl_gross": pos_data.get("current_pnl_usd", 0),
                "unrealized_pnl_pct_gross": pos_data.get("current_pnl_pct", 0),
...
if __name__ == "__main__":
    ...
    parser.add_argument("--port", type=int, default=11007)
